...
namespace GraphEditor
{
    ...
    {
        public static SerializedElement nullElement
        {
            get { return new SerializedElement(); }
        }
        ...
        static TypeInfo DoTypeRemap(TypeInfo info, Dictionary<TypeInfo, TypeInfo> remapper)
        {
            TypeInfo foundInfo;
        ...
        public static List<T> Deserialize<T>(List<SerializedElement> list, params object[] constructorArgs) where T : class
        {
