    ...
    public class EnumStructureInfo : MemberedStrucureInfo<EnumMemberInfo>
    {
        ...
        public bool CanAddMember(int memberIndex, string memberName)
        {
            ...
            if (memberInfo != null)
            {
                ...
                {
                    throw new Exception(string.Format(StaticString.SameEnumNameFormat, name, memberName));
                }
                return false;
            }
            ...
            if (memberInfo != null)
            {
                ...
                {
                    throw new Exception(string.Format(StaticString.SameEnumIndexFormat, name, memberIndex));
                }
                return false;
            }
            return true;
